      ...
      <div className="container mx-auto px-6 md:px-10 max-w-[1400px]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mb-16">
          <div className="text-center px-4">
            <h3 className="text-xl font-serif font-bold text-[#101c29] mb-4">Our Mission</h3>
          ...
          <div className="text-center px-4">
            <h3 className="text-xl font-serif font-bold text-[#101c29] mb-4">Our Vision</h3>
            <p className="text-sm text-slate-600 leading-relaxed max-w-md mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center pt-12 border-t border-slate-200">
          <div>
            <h4 className="font-bold text-[#101c29] mb-3">Core Value Focus</h4>
            <p className="text-xs text-slate-500 leading-relaxed">
              Integrity, accountability, and transparency in all our initiatives and operations.
            </p>
          </div>
          <div>
            <h4 className="font-bold text-[#101c29] mb-3">Values Where You Matter</h4>
            <p className="text-xs text-slate-500 leading-relaxed">
              We believe in the power of empathy, respect, and collaboration to drive meaningful change.
            </p>
          </div>
          <div>
            <h4 className="font-bold text-[#101c29] mb-3">Our Communities Build Us Better</h4>
            <p className="text-xs text-slate-500 leading-relaxed">
