  ...
  return (
    <div className="pt-32 pb-24 min-h-screen bg-white">
      <div className="container mx-auto px-6 md:px-10 max-w-[1400px]">
        ...
        {/* Header Section */}
        <section className="bg-[#101c29] text-white py-24 rounded-3xl mb-20 text-center px-6">
        ...
        <section className="mb-24 text-center">
          <h2 className="text-xl font-bold text-[#101c29] uppercase tracking-[0.2em] mb-4">Platinum CSR Partners</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            <div className="bg-slate-50 p-12 rounded-xl flex flex-col items-center justify-center border border-slate-100 hover:shadow-md transition-shadow">
              <h3 className="text-2xl font-serif font-bold text-[#101c29] mb-1">Global</h3>
              <p className="text-slate-400 font-serif italic">Finance Corp</p>
            </div>
            <div className="bg-slate-50 p-12 rounded-xl flex flex-col items-center justify-center border border-slate-100 hover:shadow-md transition-shadow">
              <h3 className="text-2xl font-serif font-bold text-[#101c29] mb-1">Apex</h3>
        ...
        {/* Project Sponsors */}
        <section className="mb-24 text-center">
          <h2 className="text-xl font-bold text-[#101c29] uppercase tracking-[0.2em] mb-4">Project Sponsors</h2>
        ...
        <section className="mb-24 text-center border-t border-slate-100 pt-20">
          <h2 className="text-xl font-bold text-[#101c29] uppercase tracking-[0.2em] mb-4">Indian Brands & Government Support</h2>
        ...
        <section className="bg-slate-50 rounded-3xl p-12 md:p-20 text-center max-w-5xl mx-auto border border-slate-100 shadow-sm">
          <h2 className="text-3xl font-serif font-bold text-[#101c29] mb-6">Partner With Us</h2>
          ...
          <Link href="/contact">
            <Button className="bg-[#101c29] hover:bg-[#1a2e42] text-white font-bold px-10 h-14 rounded-full shadow-lg">
              Contact CSR Desk
            </Button>
          </Link>
        </section>
